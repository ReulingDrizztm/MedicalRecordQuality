    ...
    def check_chief_time(self, collection_name, **json_file):
        ...
        for data in mongo_result:
            try:
                ...
                creator_name = collection_data.get('creator_name', '')
                last_modify_date_time = collection_data.get('last_modify_date_time', '')
                file_time_value = collection_data.get('file_time_value', '')
            ...
            try:
                ...
                if not flag and len(self.regular_model.get('CYJL0008', list())) > 6 and self.regular_model['CYJL0008'][
                    ...
                    for one_record in yizhu_result['yizhu']:
                        if one_record.get('order_time', '')[:10] == file_time_value[:10] and one_record.get(
